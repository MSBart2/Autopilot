...
Review and docs stages can also call deterministic tools for fresh PR metadata, diff summaries, and artifact-ready comment bodies instead of searching issue comments or attempting blocked GitHub writes. Tool outputs stay compact by default and include artifact references when detailed JSON has been captured for the run ledger.
