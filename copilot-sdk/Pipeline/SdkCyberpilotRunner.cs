    ...
    TextWriter output)
{
    ...
    public async Task<int> RunAsync(CancellationToken cancellationToken = default)
    {
        ...
        var engine = new PipelineEngine(pipelineContext, labels, branchCoordinator, stageExecutor, new PipelineGateRunner(BuiltInPipelineGates.Create(modelChecker, labels)), progressSink, console);
