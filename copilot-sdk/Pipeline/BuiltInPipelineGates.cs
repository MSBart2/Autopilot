...
internal static class BuiltInPipelineGates
{
    ...
    public static IReadOnlyDictionary<string, IPipelineGate> Create(IModelAvailabilityChecker modelChecker, ISdkLabelService labels, IGitHubIssueClient issueClient)
